...
namespace Laboratory.BL
{
    class Tickets
    {
      ...
      int IDCustomer, string ReassonAddStock,string elbayan)
        ...
        internal DataTable SelecthManagmentTicketsBranch(DateTime from, DateTime to)
        {
            DataTable dt = new DataTable();
        ...
        internal DataTable selectSearchTicketsReturnDateCategory(string Branch_Name, DateTime from, DateTime to, int Id_CategoryItem)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[2] = new SqlParameter("@to", SqlDbType.DateTime);
            param[2].Value = to;
            param[3] = new SqlParameter("@Id_CategoryItem", SqlDbType.Int);
            param[3].Value = Id_CategoryItem;
            dt = da.selected("selectSearchTicketsReturnDateCategory", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable Select_RowFromStock(int Id_Stock , decimal Pay_Money ,DateTime Date_, string  Reason)
        {
            DataTable dt = new DataTable();
            ...
            param[2].Value = Date_;
            param[3] = new SqlParameter("@Reason", SqlDbType.NVarChar,100);
        ...
        internal DataTable selectDataRevlation(int idBranch, DateTime fromDate,DateTime toDate, int idCategory)
        {
            DataAccessLayer da = new DataAccessLayer();
            SqlParameter[] param = new SqlParameter[4];
        ...
        internal DataTable SelectSearchticketsBranchDateCompany(int branch, DateTime from, DateTime to)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectSearchticketsBranchDateCompany", param);
            da.close();
            return dt;
        }
        internal DataTable SelectSearchticketsBranchCompany(string branch, DateTime from, DateTime to)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectSearchticketsBranchCompany", param);
            da.close();
            return dt;
        }


        internal DataTable SelectSearchticketsBranchDatePay(int branch, DateTime from, DateTime to)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectSearchticketsBranchDatePay", param);
            da.close();
            return dt;
        }
        internal DataTable SelectSearchticketsBranchPay(string branch, DateTime from, DateTime to)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectSearchticketsBranchPay", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable SelectDiscountTicketsBranchCategory(string branch, DateTime from, DateTime to, int Id_CategoryItem)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectDiscountTicketsBranchCategory", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable Report_RevenueDetails_AllBranch( DateTime Date_From, DateTime Date_To)
        {
            DataTable dt = new DataTable();
            ...
            param[1].Value = Date_To;
            dt.Clear();
            dt = da.selected("Report_RevenueDetails_AllBranch", param);
            da.close();
            return dt;
        }
